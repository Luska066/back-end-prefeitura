...
@section('estrutura.content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('estruturas.update',$estrutura->id) }}" method="POST" class="m-0 p-0">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
        <label for="id_categoria" class="form-label">Id Categoria:</label>
        <input type="number" name="id_categoria" id="id_categoria" class="form-control" value="{{@old('id_categoria', $estrutura->id_categoria)}}" />
    ...
    <div class="mb-3">
        ...
        <input type="number" name="id_pessoa_juridica" id="id_pessoa_juridica" class="form-control" value="{{@old('id_pessoa_juridica', $estrutura->id_pessoa_juridica)}}" />
    ...
    <div class="mb-3">
        ...
        <input type="text" name="title" id="title" class="form-control" value="{{@old('title', $estrutura->title)}}" required/>
        @if($errors->has('title'))
		...
		@endif
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('estruturas.index', []) }}" class="btn btn-light">Cancel</a>
